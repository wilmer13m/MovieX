...
class NowPlayingWorkerTest: XCTestCase {
    ...
    override func setUp() {
        ...
        worker = NowPlayingMoviesWorker(session: session)
    }
    ...
    func testSuccessNowPlayingMovies() {
        ...
        worker.getNowPlayingMovies(page: 1) { (success, moviesResponse) in
